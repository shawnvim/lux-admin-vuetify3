export default {
  ...
  error: {
    email_null: "E-mail is required",
    email_invalid: "E-mail must be valid",
    password_null: "Password is required",
    password_invalid: "Password must be less than 14 characters",
    password2_invalid: "Passwords do not match",
  },
  menu: {
